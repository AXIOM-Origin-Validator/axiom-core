...
fn test_genesis_state_id_deterministic() {
    let pk = [0x42u8; 32];
    let sid1 = compute_genesis_state_id(&pk, 0);
    let sid2 = compute_genesis_state_id(&pk, 0);
...
fn test_genesis_state_id_changes_with_pk() {
    let pk_a = [0x01u8; 32];
    let pk_b = [0x02u8; 32];
    let sid_a = compute_genesis_state_id(&pk_a, 0);
    let sid_b = compute_genesis_state_id(&pk_b, 0);
...
fn test_genesis_state_id_changes_with_balance() {
    let pk = [0x42u8; 32];
    let sid_0 = compute_genesis_state_id(&pk, 0);
    let sid_1 = compute_genesis_state_id(&pk, 1);
...
fn test_genesis_state_id_is_32_bytes() {
    let pk = [0xAB; 32];
    let sid = compute_genesis_state_id(&pk, 12345);
